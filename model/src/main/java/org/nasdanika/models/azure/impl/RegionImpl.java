 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.azure.impl.RegionImpl#getAvailabilityZones <em>Availability Zones</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RegionImpl extends LocationImpl implements Region {
	...
	protected EClass eStaticClass() {
		return AzurePackage.Literals.REGION;
	}
	...
	public EList<AvailabilityZone> getAvailabilityZones() {
		return (EList<AvailabilityZone>)eDynamicGet(AzurePackage.REGION__AVAILABILITY_ZONES, AzurePackage.Literals.REGION__AVAILABILITY_ZONES, true, true);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AzurePackage.REGION__AVAILABILITY_ZONES:
