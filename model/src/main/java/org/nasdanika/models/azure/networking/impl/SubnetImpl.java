 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.azure.networking.impl.SubnetImpl#getResources <em>Resources</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubnetImpl extends ResourceImpl implements Subnet {
	...
	public EList<SubnetResource> getResources() {
		return (EList<SubnetResource>)eDynamicGet(NetworkingPackage.SUBNET__RESOURCES, NetworkingPackage.Literals.SUBNET__RESOURCES, true, true);
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case NetworkingPackage.SUBNET__RESOURCES:
				getResources().clear();
				getResources().addAll((Collection<? extends SubnetResource>)newValue);
				return;
		}
