 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.azure.impl.SubscriptionImpl#getResourceGroups <em>Resource Groups</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubscriptionImpl extends ManagementGroupElementImpl implements Subscription {
	...
	protected EClass eStaticClass() {
		return AzurePackage.Literals.SUBSCRIPTION;
	}
	...
	public EList<ResourceGroup> getResourceGroups() {
		return (EList<ResourceGroup>)eDynamicGet(AzurePackage.SUBSCRIPTION__RESOURCE_GROUPS, AzurePackage.Literals.SUBSCRIPTION__RESOURCE_GROUPS, true, true);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AzurePackage.SUBSCRIPTION__RESOURCE_GROUPS:
